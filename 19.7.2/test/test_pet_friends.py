...
def test_add_new_pet_with_valid_data_without_photo(name='Chip', animal_type='Грызун',
                                     age='10'):
...
def test_add_new_pet_with_valid_data(name='Leopold', animal_type='Cat',
...
def test_add_new_photo_pet_with_valid_data(pet_id='61da4650-7eef-403d-b308-dfa3dea02792', pet_photo='images/Chip_New.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "leopold", "Cat", "25", "images/cat1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Dale', animal_type='Cat', age=9):
...
def test_get_all_pets_with_wrong_filter(filter='mymy_pets'):
  ...
  #6
def test_add_new_pet_invalid_age(name='Рокфор ', animal_type='Мышь', age='100000'):
  ...
  #7
def test_add_new_pet_negative_age(name='Вжик', animal_type='Муха', age='-99'):
    '''Проверка добавления нового питомца без фото с некорректными данными возраста:
    отрицательное число.'''
...
def test_add_new_empty_pet(name='', animal_type='', age=''):
 ...
 #10
def test_add_new_pet_with_long_name(name='Очень длинное имяяяяяяяяяяяяяяяя у меняяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяяя',
